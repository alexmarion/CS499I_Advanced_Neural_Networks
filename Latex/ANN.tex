...
\begin{center}
  \begin{table}[H]
    ...
    \begin{minipage}[b]{0.6\linewidth}
      \centering
      \includegraphics[width=150mm]{YNYNN_training_error.png}
      \captionof{figure}{Plot of YNYNN training error}
...
\begin{enumerate}
  ...
  \begin{center}
    \includegraphics[width=100mm]{num_iterations_empirical.png}
  ...
  \begin{center}
    \includegraphics[width=100mm]{hidden_node_empirical.png}
