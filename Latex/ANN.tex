...
The baseline accuracy was created using the negative form of all variants with the exception of data standardization. The baseline parameters were as follows: 40 by 40 sized images, a hidden layer size of 20, 1000 training iterations, and a learning rate of 0.05.
\begin{center}
  \begin{table}[H]
    \begin{varwidth}[b]{0.4\linewidth}
      \centering
...
\begin{enumerate}
  ...
  \begin{center}
    \includegraphics[width=125mm]{./accuracy_imgs/num_iterations_empirical.png}
  ...
  \begin{center}
    \includegraphics[width=125mm]{./accuracy_imgs/hidden_node_empirical_10_iters.png}
  ...
  \begin{center}
    \includegraphics[width=125mm]{./accuracy_imgs/img_size_empirical_500_iters.png}
  ...
  \begin{center}
    \includegraphics[width=125mm]{./accuracy_imgs/learning_rate_empirical_500_iters.png}
  ...
  \begin{center}
    \includegraphics[width=125mm]{./accuracy_imgs/pca_retention_empirical_200.png}
