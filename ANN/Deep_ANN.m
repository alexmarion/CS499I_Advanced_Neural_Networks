classdef Deep_ANN
    ...
    methods
        ...
        function [] = plot_training_accuracy( deep_ann,testing_accuracy,training_accuracy )
            fig = figure();
            plot(training_accuracy(:,1), training_accuracy(:,2));
            legend('Training Accuracy');
            xlabel('Iteration');
            ...
            title(c_flow_str);
            saveas(fig,sprintf('../Deep_Latex/accuracy_imgs/%s_training_accuracy.png',c_flow_str));
